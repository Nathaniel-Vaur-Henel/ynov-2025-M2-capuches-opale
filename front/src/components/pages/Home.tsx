...
export default function Home() {
  return (
    <div
      className="relative h-screen w-full flex flex-col items-center justify-center px-6 space-y-10 bg-cover bg-center"
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            maskImage:
              "radial-gradient(circle, rgba(0,0,0,0) 20%, rgba(0,0,0,0.9) 95%)",
          }}
        ></div>
      </div>
      ...
      <div className="relative">
        <button
          className="bg-indigo-600 hover:bg-indigo-700 text-xl font-semibold px-10 py-4 rounded-xl shadow-xl transition duration-300
